...
export function WhatsAppButton() {
  ...
  const handleWhatsAppClick = (number: string): void => {
    window.open(`https://wa.me/${number}`, '_blank');
    setIsOpen(false);
  };

  return (
    <div className="whatsapp-container" ref={containerRef}> {/* ← ADD ref HERE */}
      {/* Dropdown menu */}
      {isOpen && (
        <div className="whatsapp-menu">
          <div className="menu-header">Contact Us</div>
          {whatsappNumbers.map((contact, index) => (
            ...
            >
              <div className="whatsapp-icon-small">
